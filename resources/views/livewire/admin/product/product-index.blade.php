<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        ...
        <div class="card-toolbar">
            <!--begin::Button-->
            <a href="{{ url('manage-product') }}" class="btn btn-primary font-weight-bolder">
                ...
                <thead class="datatable-head">
                    <tr class="datatable-row" style="left: 0px;">
                        ...
                        <th data-field="Country" class="datatable-cell datatable-cell-sort"><span
                                style="width: 108px;">Country</span></th>
                        <th data-field="ShipDate" class="datatable-cell datatable-cell-sort"><span
                                style="width: 108px;">Ship Date</span></th>
                        <th data-field="CompanyName" class="datatable-cell datatable-cell-sort" style="display: none;">
                        ...
                        <th data-field="Type" data-autohide-disabled="false"
                            class="datatable-cell datatable-cell-sort"><span style="width: 108px;">Type</span></th>
                ...
                <tbody class="datatable-body" style="">
                    <tr data-row="0" class="datatable-row" style="left: 0px;">
                        <td class="datatable-cell datatable-toggle-detail"><a class="datatable-toggle-detail"
                                href=""><i class="fa fa-caret-right"></i></a></td>
                        <td class="datatable-cell-center datatable-cell datatable-cell-check" data-field="RecordID"
                            aria-label="21"><span style="width: 20px;"><label class="checkbox checkbox-single"><input
                                        type="checkbox" value="21">&nbsp;<span></span></label></span></td>
                        <td data-field="OrderID" aria-label="68382-161" class="datatable-cell"><span
                                style="width: 108px;">68382-161</span></td>
                        <td data-field="Country" aria-label="Japan" class="datatable-cell"><span
                                style="width: 108px;">Japan JP</span></td>
                        <td data-field="ShipDate" aria-label="4/26/2017" class="datatable-cell"><span
                                style="width: 108px;">4/26/2017</span></td>
                        <td data-field="CompanyName" aria-label="Maggio-Friesen" class="datatable-cell"
                            style="display: none;"><span style="width: 108px;">Maggio-Friesen</span></td>
                        <td data-field="Status" aria-label="5" class="datatable-cell" style="display: none;"><span
                        ...
                        <td data-field="Type" data-autohide-disabled="false" aria-label="3" class="datatable-cell">
                            <span style="width: 108px;"><span class="label label-success label-dot mr-2"></span><span
                                    class="font-weight-bold text-success">Direct</span></span>
                        </td>
